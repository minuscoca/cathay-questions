...
.container .shop-list .item {
  /* Q1. /_ Explain why does this color not works, and how to fix make it work on 1st list _/ */
  color: blue;
}
/* Q2. /_ Write styling make every other line give background color to next one _/ */
```
